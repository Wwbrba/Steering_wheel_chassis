...
//////////////////////////////////////////////////
RobosenseOdeMultiRayShape::RobosenseOdeMultiRayShape(CollisionPtr _parent)
...
//////////////////////////////////////////////////
RobosenseOdeMultiRayShape::~RobosenseOdeMultiRayShape()
{
...
//////////////////////////////////////////////////
void RobosenseOdeMultiRayShape::UpdateRays()
{
...
//////////////////////////////////////////////////
void RobosenseOdeMultiRayShape::UpdateCallback(void *_data, dGeomID _o1, dGeomID _o2)
{
    dContactGeom contact;
    RobosenseOdeMultiRayShape *self = NULL;

    self = static_cast<RobosenseOdeMultiRayShape *>(_data);
    ...
    else
    {
        ...
        if (rayCollision && hitCollision)
        {
            ...
            if (n > 0)
            {
                ...
                {
                    // gzerr << "RobosenseOdeMultiRayShape UpdateCallback dSpaceCollide2 "
                    //      << " depth[" << contact.depth << "]"
...
//////////////////////////////////////////////////
void RobosenseOdeMultiRayShape::AddRay(const ignition::math::Vector3d &_start,
...
void RobosenseOdeMultiRayShape::Init()
{

...
namespace gazebo
{
   ...
   class RobosensePointsPlugin : public RayPlugin
   {
   public:
      RobosensePointsPlugin();

      virtual ~RobosensePointsPlugin();
   ...
   private:
      ...
      boost::shared_ptr<physics::RobosenseOdeMultiRayShape> rayShape;
...
#endif // ROBOSENSE_SIM_POINTS_PLUGIN_H

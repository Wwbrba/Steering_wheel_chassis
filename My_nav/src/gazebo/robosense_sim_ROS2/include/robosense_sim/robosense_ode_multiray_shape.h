...
#ifndef ROBOSENSE_SIM_ODE_MULTIRAY_SHAPE_H
#define ROBOSENSE_SIM_ODE_MULTIRAY_SHAPE_H
...
namespace gazebo{
namespace physics{
class GZ_PHYSICS_VISIBLE RobosenseOdeMultiRayShape : public MultiRayShape{
    /// \brief Constructor.
    /// \param[in] _parent Parent Collision.
    public: explicit RobosenseOdeMultiRayShape(CollisionPtr _parent);

    /// \brief Destructor.
    public: virtual ~RobosenseOdeMultiRayShape();
 ...
 private:
    std::vector<RayShapePtr> robosenseRays;
};
}
}


#endif  // ROBOSENSE_SIM_ODE_MULTIRAY_SHAPE_H
